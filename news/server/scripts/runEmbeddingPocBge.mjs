/**
 * BGE-M3 Embedding POC（Node / @xenova/transformers）
 *
 * 用法（在 news 目录）：
...
// 国内网络：可用 HF_ENDPOINT=https://hf-mirror.com
...
const OUT_JSON = path.join(DATA_DIR, 'report-bge-m3.json');
const OUT_MD = path.join(DATA_DIR, 'report-bge-m3.md');
const TOP_K = 20;
