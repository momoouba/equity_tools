...
async function syncShanghaiInternationalGroupExecPersData(configId = null, logId = null) {
  try {
    ...
    const apiUrl = SHANGHAI_INTERNATIONAL_EXECPERS_URL;
    let totalSynced = 0;
    const errors = [];
    let requestIndex = 0;
...
async function syncShanghaiInternationalGroupDiscrdtExecData(configId = null, logId = null) {
  try {
    ...
    const apiUrl = SHANGHAI_INTERNATIONAL_DISCRDTEXEC_URL;
    let totalSynced = 0;
    const errors = [];
    let requestIndex = 0;
...
async function syncShanghaiInternationalGroupRestrictHighConsData(configId = null, logId = null) {
  try {
    ...
    const apiUrl = SHANGHAI_INTERNATIONAL_RESTRICTHIGHCONS_URL;
    let totalSynced = 0;
    const errors = [];
    let requestIndex = 0;
...
async function syncShanghaiInternationalGroupJudgmentData(configId = null, logId = null) {
  try {
    ...
    const apiUrl = SHANGHAI_INTERNATIONAL_JUDINSTRMNT_URL;
    let totalSynced = 0;
    const errors = [];
    let requestIndex = 0;
...
async function syncShanghaiInternationalGroupCourtAnnouncementData(configId = null, logId = null) {
  try {
    ...
    const apiUrl = SHANGHAI_INTERNATIONAL_CRTANNCMNT_URL;
    let totalSynced = 0;
    const errors = [];
    let requestIndex = 0;
...
async function syncShanghaiInternationalGroupCourtHearingData(configId = null, logId = null) {
  try {
    ...
    const apiUrl = SHANGHAI_INTERNATIONAL_SESSANNCMNT_URL;
    let totalSynced = 0;
    const errors = [];
    let requestIndex = 0;
...
async function syncShanghaiInternationalGroupFilingData(configId = null, logId = null) {
  try {
    ...
    const apiUrl = SHANGHAI_INTERNATIONAL_FILING_URL;
    let totalSynced = 0;
    const errors = [];
    let requestIndex = 0;
