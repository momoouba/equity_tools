...
1. 与目标 **core_product_lines** 直接对位的同业（同类装备/耗材/SKU，含本土中小企业）
2. 不得仅因同属生物制药、生命科学、医疗健康等大行业而列入；须说明与目标哪条 core_product_lines 对齐
3. 中国大陆上市公司（硬性至少 3 家）：须与目标**核心品类**最相似，按 ai_relevance_score 降序
4. 跨国品牌在华主体、港股、美股等可列为 substitute 候选，不计入上述 3 家国内名额
...
4. **仅大行业/客户类型相同，core_product_lines 或 product_intro 核心 SKU 未对齐**：不得判 direct/indirect/substitute；应判 same_track 或 not_competitor，validated_score≤45。
