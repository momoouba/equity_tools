...
const RADIOPHARMA_TARGET_SIGNAL_RE =
  /核药|放射性药物|放射性核素药物|核素药物|核素偶联|核素偶联药物|RDC|放射性配体|诊疗一体化|PET成像药物|核医学.*药|镥|Lu-177|镥-177|Lu177|锕|Ac-225|锕-225|砹|At-211|砹-211|Pb-212|铅-212|99mTc|锝/i;
/**
 * 候选赛道命中：不含单独「诊疗一体化」，避免把非核药「诊疗/靶向」公司扩进核药池。
 * 上游核素供应/核医学服务仍命中，供赛道扩池与模态门共用。
 */
const RADIOPHARMA_TRACK_RE =
  /核药|放射性药物|核素药物|核素偶联|核素偶联药物|RDC|放射性配体|诊疗一体化核药|PET成像药物|PET显像剂|核医学.*药|同位素.*药|同位素药物|核素.*偶联|镥-177|Lu-177|Lu177|锕-225|Ac-225|砹-211|At-211|Pb-212|铅-212|99mTc|锝|放射性.*示踪|放射性核素|α核素|核素.*生产|核素.*供应|核技术.*医药|同位素.*制备|回旋加速器.*核素/i;
...
function looksLikeNonRadiopharmaModality(profile) {
  ...
  const nonIsoModality =
    /小分子|抗体|双抗|ADC|抗体偶联|CAR-T|CAR-NK|细胞治疗|基因治疗|基因编辑|多肽|GLP-1|PROTAC|mRNA|疫苗|抗病毒|抗感染|CNS|中枢神经|神经科学|阿尔茨海默|帕金森|神经退行|脑环路|离子通道|AI.*制药|AI.*药物|计算.*药物|大分子|蛋白药|核酸药|siRNA|寡核苷酸/i.test(
      blob
    );
