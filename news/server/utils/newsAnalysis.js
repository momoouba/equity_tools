...
`;
  ...
  async processNewsWithEnterprise(newsItem) {
    try {
      ...
      if ((newsItem.account_name === '裁判文书' || newsItem.account_name === '法院公告' || newsItem.account_name === '送达公告' || newsItem.account_name === '开庭公告') && (newsItem.APItype === '上海国际' || newsItem.APItype === '上海国际集团')) {
