...
async function generateIdUnlocked(tableName, connection) {
  ...
  try {
    ...
    const validTableNames = [
      ...
      'perf_stock_price', 'perf_exchange_rate', 'perf_mapping_config',
      ...
      'valuation_dcf_run',
      'valuation_dcf_year',
      'valuation_dcf_sens_cell',
      'valuation_forecast_pl_line',
      'valuation_industry_result',
      'valuation_fetch_log',
      'valuation_change_log',
      'valuation_job',
      'listed_company_financials',
      'listed_company_market_multiples',
      'industry_market_multiples',
      'valuation_sw_constituent',
      'valuation_sw_industry',
