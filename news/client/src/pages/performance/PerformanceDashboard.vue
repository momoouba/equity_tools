...
import { versionApi, dashboardApi, configApi } from '../../api/performance';

// 导入子组件
import ManagerIndicator from '../../components/performance/ManagerIndicator.vue';
import FundIndicators from '../../components/performance/FundIndicators.vue';
import PortfolioSection from '../../components/performance/PortfolioSection.vue';
import UnderlyingSection from '../../components/performance/UnderlyingSection.vue';

// 导入弹窗组件
import ManagerFundsModal from '../../components/performance/modals/ManagerFundsModal.vue';
import InvestorsModal from '../../components/performance/modals/InvestorsModal.vue';
import FundPerformanceModal from '../../components/performance/modals/FundPerformanceModal.vue';
import FundPortfolioModal from '../../components/performance/modals/FundPortfolioModal.vue';
import ProjectCashflowModal from '../../components/performance/modals/ProjectCashflowModal.vue';
import PortfolioDetailModal from '../../components/performance/modals/PortfolioDetailModal.vue';
import UnderlyingCompaniesModal from '../../components/performance/modals/UnderlyingCompaniesModal.vue';
import IpoCompaniesModal from '../../components/performance/modals/IpoCompaniesModal.vue';
import RegionCompaniesModal from '../../components/performance/modals/RegionCompaniesModal.vue';
import SettingsModal from '../../components/performance/modals/SettingsModal.vue';
import VersionUpdateModal from '../../components/performance/modals/VersionUpdateModal.vue';
import ShareModal from '../../components/performance/modals/ShareModal.vue';
